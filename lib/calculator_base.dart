...
class CalculatorBase extends StatefulWidget {
  const CalculatorBase({Key? key}) : super(key: key);

  @override
  State<CalculatorBase> createState() => _CalculatorBaseState();
}

class _CalculatorBaseState extends State<CalculatorBase> {
  String input = "";
  String output = "";
